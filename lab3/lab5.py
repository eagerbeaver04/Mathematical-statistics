...
def lab5():
    ...
    for n in ns:
        ...
        for i, rho in enumerate(rhos):
            ...
            ax[i].grid()
            ax[i].set_title(fr'n = {n}, $\rho$ = {rho}')
            add_confidence_ellipse(x, y, ax[i], 1, edgecolor='red')
            add_confidence_ellipse(x, y, ax[i], 2, edgecolor='fuchsia', linestyle='--')
            add_confidence_ellipse(x, y, ax[i], 3, edgecolor='blue', linestyle=':')
